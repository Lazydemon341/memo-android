...
import com.memo.chat.internal.ui.base.Visibility.GONE
import com.memo.chat.internal.ui.base.Visibility.VISIBLE
...
internal fun JumpToBottom(
    ...
    if (bottomOffset > 0.dp) {
        ExtendedFloatingActionButton(
            ...
            text = {
                Text(
                    text = stringResource(id = R.string.jump_to_bottom_button_text),
